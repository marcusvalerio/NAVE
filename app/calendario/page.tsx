        ...
        {diaSelecionado && (
          <>
            ...
            <motion.div
              ...
              style={{position:"fixed",left:0,right:0,bottom:0,maxWidth:520,margin:"0 auto",zIndex:50,background:"var(--surface)",borderTop:"1px solid var(--border)",borderRadius:"16px 16px 0 0",padding:"18px 20px",maxHeight:"70vh",overflowY:"auto"}}>
